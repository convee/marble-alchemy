...
(function () {
  ...
  var common = {
    ...
    '米小圈：':'Mickey: ', '铁头说他只认识':'Titou only knows ', '姜小牙说历史书太贵他也没看':'Jiang says history books cost too much, so he has not read one', '《我最喜欢的历史人物》':'“My Favorite Historical Person”', '可我一个历史人物都不认识！':'but I do not know any historical person!', '（那是神话啦！）':'(that is a legend!)', '快跟我一起':'Come travel with me ', '穿越时空':'through time', '从远古一路玩到明清':'from ancient times to the Ming and Qing eras', '每一关都有宝物收集哦':'and collect a treasure in every stage', '完蛋啦！':'Oh no!', '魏老师留了作业':'Teacher Wei assigned homework', '，每一关都有宝物收集哦！':', and collect a treasure in every stage!',
    '叮铃铃——闹钟响啦！':'Ring ring—the alarm is ringing!', '今天是':'It is ', '又赖床了':'is still in bed', '米小圈又赖床了。':'Mickey is still in bed.', '要经历':'You will ', '七件大事':'seven big moments', '七件大事，':'seven big moments,', '还会遇到铁头、姜小牙、李黎、魏老师和莫老师……':'and meet Titou, Jiang, Lily, Teacher Wei and Teacher Mo…', '不好啦！一阵超级大风把我的书包吹上了天，课本撒了一路！':'Oh no! A huge gust blew my schoolbag into the sky and scattered my books!', '魏老师说过：':'Teacher Wei said: ', '快帮我一路蹦蹦跳跳捡回课本，躲开大白鹅和泥水坑，赶在上课铃响前冲到学校吧！':'Help me hop along, collect the books, dodge the goose and puddles, and reach school before the bell!',
    '挖掉':'Dig ', '方块':'blocks', '放上':'place ', '，或者':', or', '喜欢的方块盖小房子':'your favorite blocks to build a home', '你搭的世界会':'Your world ', '自动保存':'saves automatically', '，下次接着玩～':', next time.'
  };
