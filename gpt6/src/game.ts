...
export const UPGRADES: Upgrade[] = [
  {
    ...
    color: '#bd9bff',
    tag: '基础增幅 · 可叠加',
    description: '每次碰撞的基础伤害 +1。每一次触碰，都更有力量。',
  },
  {
    id: 'fire',
    name: '火焰',
    ...
    color: '#ffad76',
    tag: '元素附魔 · 可叠加',
    description: '每次碰撞额外累计 1 点火焰伤害。重复获得可叠加。',
  },
  {
    id: 'lightning',
    name: '闪电',
    ...
    color: '#f4d884',
    tag: '连锁反应 · 唯一',
    description: '碰撞时连接最近的另外两颗钉子，各造成 1 点伤害。连锁不再触发连锁。',
  },
  {
    id: 'split',
    name: '分裂',
    ...
    color: '#8df0cd',
    tag: '弹珠变异 · 唯一',
    description: '每次发射的首次碰撞额外生成 2 颗弹珠。新弹珠不会继续分裂。',
  },
  {
    id: 'critical',
    name: '暴击',
    ...
    color: '#ff93bb',
    tag: '幸运催化 · 唯一',
    description: '每次碰撞有 20% 概率使本次直接伤害翻倍，包含火焰，不含闪电连锁。',
  },
  {
    id: 'heal',
    name: '治疗',
    ...
    color: '#8fcdf6',
    tag: '即时恢复 · 可重复',
    description: '立即恢复 2 点生命，最多恢复至 5 点。让下一次实验更从容。',
  },
];
export const LEVELS = [
  {
