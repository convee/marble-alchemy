...
> 本目录是双版本对比仓库的 Codex 版实现。另一版在 [`../fable5.1/`](../fable5.1/)，对比首页见 [仓库根 README](../README.md) 与 https://chaoschemy.com/ 。
...
> [在线试玩](https://chaoschemy.com/gpt6/) · [完整无剪辑录屏（v1.0.0）](https://github.com/convee/marble-alchemy/releases/download/v1.0.0/codex-gameplay-v1.0.0.mp4) · [测试与测评证据](evaluation/README.md)
