...
| 获客 | 英文首页、游戏页、field guide、canonical、sitemap、robots 已上线；事实版 X Thread 已发布（1/3、2/3、3/3）；Roguelite.org 投稿邮件已发送 | conditional | Product Hunt 与 itch.io 当前被 Cloudflare 安全验证拦截；BrowserCraft 无公开投稿入口；DEV/Hashnode 需要登录；先验证 Search Console，再按规则做 5–15 条人工外链 |
